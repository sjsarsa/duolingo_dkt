...
def logistic_regression(training_data, training_labels, test_data):
    ...
    return logistic_regression_model.predict_test_set(test_instances)
...
class LogisticRegression(object):
    ...
    def train(self, train_set, iterations=10):
        for it in range(iterations):
            ...
            print('Iteration time ' + str(time() - start_time))
        print('\n')
